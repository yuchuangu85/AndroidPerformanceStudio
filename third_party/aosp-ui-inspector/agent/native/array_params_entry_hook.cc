...
/*
 * This file is copied from the app-inspection native agent implementation.
 *
 * Purpose:
 * Implements the bytecode visitor and slicing mechanics to inject local arrays,
 * copy and box primitive registers, and construct the `Object[]` callback
 * package at method entries.
 *
 * Key changes from app inspection:
 * - Namespace changed to `ui_inspector`.
 */
