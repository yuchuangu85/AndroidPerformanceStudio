...
export const LAYOUT_STRINGS = {
  ...
  'pane.findings': { en: 'FINDINGS', zh: '问题' },
  ...
  'view.hideInvisibleFindings': { en: 'Hide invisible-view findings', zh: '隐藏问题列表中的不可见视图内容' },
  'findings.none': { en: 'No findings', zh: '暂无问题' },
  'badge.info': { en: 'INFO {0}', zh: '信息 {0}' },
  'badge.warning': { en: 'WARN {0}', zh: '警告 {0}' },
  'badge.error': { en: 'ERROR {0}', zh: '错误 {0}' },
  'finding.invisibleNode': { en: 'Invisible node', zh: '不可见节点' },
  'finding.excessiveChildren': { en: 'Too many children', zh: '子节点过多' },
  'finding.overlappingSiblings': { en: 'Overlapping sibling bounds', zh: '兄弟节点区域重叠' },
  'finding.deepHierarchy': { en: 'Deep hierarchy', zh: '层级过深' },
  'finding.invisibleNode.message': { en: '{0} exists but is currently invisible', zh: '{0} 节点存在但当前不可见' },
  'finding.excessiveChildren.message': {
    en: '{0} direct children, exceeding the threshold of {1}',
    zh: '直接子节点数量 {0}，超过阈值 {1}',
  },
  'finding.overlappingSiblings.message': {
    en: '{0} siblings overlap by at least {1}%; this is a structural rendering risk—confirm with GPU tools',
    zh: '{0} 个兄弟节点的边界重叠比例至少为 {1}%；这是结构性渲染风险，请使用 GPU 工具进一步确认',
  },
  'finding.deepHierarchy.message': {
    en: 'Hierarchy depth {0} exceeds the threshold of {1}',
    zh: '层级深度 {0}，超过阈值 {1}',
  },
