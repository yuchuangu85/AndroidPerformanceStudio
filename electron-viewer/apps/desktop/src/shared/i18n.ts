...
export const SHELL_STRINGS = {
  ...
  'layout.noApp': { en: 'No app', zh: '无应用' },
  // The header row's controls, ported from the reference's resources.
  'layout.target': { en: 'Target', zh: '目标' },
  'layout.targetForegroundApp': { en: 'Foreground app', zh: '前台应用' },
  'layout.targetSystemUi': { en: 'System UI', zh: '系统界面' },
  ...
  'layout.archivedTimeline': { en: 'Archived timeline', zh: '已归档时间线' },
  'layout.archivedAnalysis': { en: 'Showing the analysis report persisted in this capture archive.', zh: '正在显示此采集归档中持久化的分析报告。' },
  'layout.archivedAiAnalysis': { en: 'Archived AI analysis', zh: '已归档 AI 分析' },
  'layout.archivedAiRecommendation': { en: 'Recommendation', zh: '建议' },
  'layout.archivedAiNone': { en: 'The archived AI analysis has no findings.', zh: '已归档 AI 分析没有发现项。' },
  ...
  // The menu is its own surface, so it carries its own wording rather than the
  // settings form's.
  'menu.actions': { en: 'Actions', zh: '操作' },
  'menu.file': { en: 'File', zh: '文件' },
  'menu.importArchive': { en: 'Import capture archive…', zh: '导入采集归档…' },
  'menu.openRecent': { en: 'Open Recent', zh: '最近打开' },
  'menu.noRecentArchives': { en: 'No Recent Archives', zh: '暂无最近归档' },
  'menu.clearRecent': { en: 'Clear Menu', zh: '清除菜单' },
  'menu.exportArchive': { en: 'Export capture archive…', zh: '导出采集归档…' },
  'menu.view': { en: 'View', zh: '视图' },
  'menu.autoScan': { en: 'Auto scan', zh: '自动扫描' },
  'menu.previousNode': { en: 'Previous node', zh: '上一个节点' },
  'menu.nextNode': { en: 'Next node', zh: '下一个节点' },
  'menu.toggleSelectedNode': { en: 'Collapse/expand node', zh: '折叠/展开节点' },
  'menu.toggleHierarchy': { en: 'Hide left panel', zh: '隐藏左侧栏' },
  'menu.toggleFindings': { en: 'Hide bottom panel', zh: '隐藏底部栏' },
  'menu.toggleDetails': { en: 'Hide right panel', zh: '隐藏右侧栏' },
  'menu.showLayoutIds': { en: 'Show layout IDs', zh: '显示布局 ID' },
  'menu.hideInvisibleHierarchyViews': { en: 'Hide invisible views in hierarchy', zh: '隐藏层级结构中的不可见视图' },
  'menu.hideInvisibleFindings': { en: 'Hide invisible-view findings', zh: '隐藏问题列表中的不可见视图内容' },
  'menu.hideHierarchyIndices': { en: 'Hide hierarchy indices', zh: '隐藏层级索引' },
  'menu.showLayerVisibilityButtons': { en: 'Show visibility buttons in hierarchy', zh: '显示层级结构中的显示按钮' },
  'menu.showVisibleViewBounds': { en: 'Show all visible view bounds', zh: '显示全部可见视图边缘' },
  ...
  'layout.isolateSubtree': { en: 'Isolate', zh: '隔离子树' },
  'layout.isolateParent': { en: 'Parent', zh: '上级' },
  'layout.clearIsolation': { en: 'Clear', zh: '清除隔离' },
  'layout.searchHierarchy': { en: 'Search hierarchy', zh: '搜索层级' },
  'layout.searchPrevious': { en: 'Previous match', zh: '上一个匹配' },
  'layout.searchNext': { en: 'Next match', zh: '下一个匹配' },
  'layout.searchNoMatch': { en: 'No match', zh: '无匹配' },
  'layout.searchClear': { en: 'Clear search', zh: '清除搜索' },
  'layout.toggleLayerVisibility': {
    en: 'Toggle this layer in canvas hit testing',
    zh: '切换此层级是否参与画布命中测试',
  },
  ...
  'startup.import': { en: 'Import JSON', zh: '导入 JSON' },
  'startup.importSqlite': { en: 'Import SQLite', zh: '导入 SQLite' },
  'startup.export': { en: 'Export JSON', zh: '导出 JSON' },
  'startup.imported': { en: 'Startup report imported', zh: '启动报告已导入' },
  'startup.importedSqlite': { en: 'Startup database imported', zh: '启动数据库已导入' },
  'startup.importedEvidence': { en: 'Imported evidence', zh: '导入证据' },
  'startup.sourceFile': { en: 'Source file', zh: '源文件' },
  'startup.sourceDevice': { en: 'Source device pseudonym', zh: '源设备伪名' },
  'startup.sourceHash': { en: 'Source database SHA-256', zh: '源数据库 SHA-256' },
  'startup.metricEvidence': { en: 'Metric evidence', zh: '指标证据' },
  'startup.importLimitations': { en: 'Import limitations', zh: '导入限制' },
  'startup.exported': { en: 'Startup report exported', zh: '启动报告已导出' },
  ...
  'method.process': { en: 'Process', zh: '进程' },
  'method.noProcesses': {
    en: 'No debuggable or profileable app processes found',
    zh: '未发现可调试或可 profile 的应用进程',
  },
  'method.processesLoading': { en: 'Loading eligible processes…', zh: '正在加载可用进程…' },
  'method.refreshProcesses': { en: 'Refresh processes', zh: '刷新进程' },
  'method.processesFailed': { en: 'Could not load processes', zh: '无法加载进程' },
  'method.duration': { en: 'Duration (s)', zh: '时长（秒）' },
  'method.captureAction': { en: 'Start recording', zh: '开始录制' },
  'method.capturing': { en: 'Recording…', zh: '录制中…' },
  'method.stopAction': { en: 'Stop recording', zh: '停止录制' },
  'method.stopping': { en: 'Stopping…', zh: '正在停止…' },
  'method.stopFailed': { en: 'Could not stop recording', zh: '无法停止录制' },
  'method.importAction': { en: 'Import trace', zh: '导入 Trace 文件' },
  'method.imported': { en: 'Trace imported', zh: 'Trace 文件已导入' },
  'method.importFailed': { en: 'Trace import failed', zh: 'Trace 文件导入失败' },
  'method.importNote': {
    en: 'Import an existing ART .trace without connecting to a device.',
    zh: '无需连接设备即可导入已有的 ART .trace 文件。',
  },
  'method.importedTrace': { en: 'Imported trace', zh: '已导入 Trace' },
  ...
  'cpu.period': { en: 'Period (events)', zh: '周期（事件数）' },
  'cpu.rateMode': { en: 'Sampling rate mode', zh: '采样速率模式' },
  'cpu.rateFrequency': { en: 'Frequency (-f)', zh: '频率（-f）' },
  'cpu.ratePeriod': { en: 'Period (-c)', zh: '周期（-c）' },
  ...
  'cpu.exportAction': { en: 'Export session package', zh: '导出会话包' },
  'cpu.open': { en: 'Open selected profile', zh: '打开所选采样' },
  'cpu.opened': { en: 'Profile opened', zh: '采样已打开' },
  'cpu.openFailed': { en: 'Open failed', zh: '打开失败' },
  'cpu.imported': { en: 'Profile imported', zh: '采样文件已导入' },
  'cpu.importFailed': { en: 'Import failed', zh: '导入失败' },
  'cpu.exported': { en: 'Session package exported', zh: '会话包已导出' },
  'cpu.exportFailed': { en: 'Session package export failed', zh: '会话包导出失败' },
  ...
  'memory.heapDiff': { en: 'Heap diff', zh: '堆差异' },
  'memory.diffBaseline': { en: 'Baseline', zh: '基线' },
  'memory.diffCurrent': { en: 'Current', zh: '当前' },
  'memory.selectBaseline': { en: 'Select a baseline session', zh: '选择基线会话' },
  'memory.compareAction': { en: 'Compare heaps', zh: '比较堆' },
  'memory.comparing': { en: 'Comparing…', zh: '比较中…' },
  'memory.noBaseline': { en: 'Capture or select another memory session to compare.', zh: '请抓取或选择另一个内存会话进行比较。' },
  'memory.diffPartial': {
    en: 'This comparison uses a legacy top-class histogram and may omit smaller classes.',
    zh: '此比较使用旧会话的前列类直方图，可能遗漏较小的类。',
  },
  'memory.noDiffChanges': { en: 'No class changes between these heap dumps.', zh: '这两个堆转储之间没有类变化。' },
  'memory.diffFailed': { en: 'Heap comparison failed.', zh: '堆比较失败。' },
  'memory.beforeCount': { en: 'Before count', zh: '比较前实例数' },
  'memory.afterCount': { en: 'After count', zh: '比较后实例数' },
  'memory.countDelta': { en: 'Count Δ', zh: '实例数变化' },
  'memory.shallowDelta': { en: 'Shallow Δ', zh: '浅层大小变化' },
  ...
  'settings.accentColor': { en: 'Theme colour', zh: '主题色' },
  'accentColor.default': { en: 'Default', zh: '默认' },
  'accentColor.banana-red': { en: 'Banana red', zh: '蕉红' },
  'accentColor.warm-sun-orange': { en: 'Warm sun orange', zh: '暖阳橙' },
  'accentColor.cornflower-blue': { en: 'Cornflower blue', zh: '矢车菊蓝' },
  'accentColor.jade-green': { en: 'Jade green', zh: '翠微' },
  'accentColor.merlot-pink': { en: 'Merlot pink', zh: '梅洛粉' },
  'accentColor.azure': { en: 'Azure', zh: '碧青' },
  'accentColor.lemon-yellow': { en: 'Lemon yellow', zh: '柠檬黄' },
  'accentColor.royal-purple': { en: 'Royal purple', zh: '皇家紫' },
  'settings.displayScale': { en: 'Display size', zh: '显示大小' },
  'settings.displayScaleHint': {
    en: 'Scales the whole window. The setting is stored as a percentage of the default size.',
    zh: '按百分比缩放整个窗口，取值以默认大小为 100%。',
  },
  ...
  'settings.captureArchiveUnavailable': {
    en: 'Kotlin-compatible .apinspect v1/v2 archives can be imported and exported from the native File menu.',
    zh: '可从原生“文件”菜单导入和导出兼容 Kotlin 的 .apinspect v1/v2 归档。',
  },
  'settings.captureArchiveLimit': { en: 'Snapshot limit', zh: '快照上限' },
  'layout.archiveImported': { en: 'Capture archive imported', zh: '采集归档已导入' },
  'layout.archiveExported': { en: 'Capture archive exported', zh: '采集归档已导出' },
  ...
  'settings.openUserGuide': { en: 'Open in browser', zh: '在浏览器中打开' },
