...
function probeSource(seconds) {
  return [
    ...
    '        await sleep(150);',
    '        // Expand down the list, not just at the top: the deeper rows are only',
    '        // rendered once the container has been scrolled to them.',
    ...
    '    };',
    '    const expandedRows = await expand(40);',
