...
| Canvas 命中候选排序、同点轮选、隐藏层级穿透 | 🚀 已纳入 v0.1.9 | 2026-07-08 15:28:44 +0800 | `062fbf8` | 小面积优先/Z 序可切换；保留同点轮选；隐藏层级作为强制穿透手段。 |
...
| --- | --- | --- | --- | --- |
| v0.3.1 | 🚀 已发布 | 2026-07-21 23:32:16 +0800 | `ecd7f1b` | 修复 GitHub Release 分支发布门禁并发布 0.3.1。 |
...
| v0.2.0 | 🚀 已发布 | 2026-07-08 16:57:19 +0800 | `65a4123` | 0.2.0 installer release。 |
| v0.2.1 | 🚀 已发布 | 2026-07-10 22:43:19 +0800 | `c873118` | 0.2.1 maintenance release。 |
| v0.2.2 | 🚀 已发布 | 2026-07-11 09:40:55 +0800 | `588245e` | 刷新性能优化与窗口切换 canvas refresh 修复。 |
| v0.2.3 | 🚀 已发布 | 2026-07-11 19:56:54 +0800 | `a259dec` | layout-only fallback 与禁用 ADB screencap 设备支持。 |
