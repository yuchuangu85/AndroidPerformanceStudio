...
## 2026-07-22 至 2026-07-25 关键提交

| 功能/模块 | 状态 | 完成/记录提交时间 | Commit | 说明 |
| --- | --- | --- | --- | --- |
| SystemUI 与 Launcher Taskbar 采集兼容 | ✅ 已完成 | 2026-07-22 10:37:55 +0800 | `e2a9530`、`349ee09`、`98735aa` | 增加 SystemUI fallback、Launcher taskbar 和裸 Taskbar window 识别。 |
| 桌面端 UI 架构图 | ✅ 已完成 | 2026-07-22 11:53:43 +0800 | `75145b1` | 记录主要页面、控件和布局关系。 |
| Loopback profiler 路由修复 | 🚀 已发布 | 2026-07-22 14:48:48 +0800 | `1398759` | 修复 profiler 本地路由并进入 release。 |
| 桌面平台控件边界 | ✅ 已完成 | 2026-07-22 15:45:11 +0800 | `0370c0a` | 将桌面控件保持在平台 surface 边界内。 |
| Layout Inspector 缩放与导航交互 | ✅ 已完成 | 2026-07-23 21:22:18 +0800 | `bd4535e`、`751feea`、`6ce0f41` | 增加 Command/鼠标滚轮缩放并改善导航响应性。 |
| Perfetto Trace Analyzer | ✅ 已完成 | 2026-07-24 07:28:35 +0800 | `ded4bc6` | 引入 trace 采集、分析和可视化功能域。 |
| Memory Profiler | ✅ 已完成 | 2026-07-24 18:06:33 +0800 | `4ff7277` | 提供可见、可验证的 Android heap 分析。 |
| Frame Profiler 与跨工具关联 | ✅ 已完成 | 2026-07-25 00:45:47 +0800 | `7f82765`、`0481d9d`、`a700db8` | 支持文件/设备帧分析、高保真计时和布局关联。 |
| Startup Profiler | ✅ 已完成 | 2026-07-25 01:43:32 +0800 | `bc7f0cf` | 将平台启动计时扩展为可重复诊断。 |
| Battery Profiler | ✅ 已完成 | 2026-07-25 02:21:00 +0800 | `a9f5a0c` | 提供无需设备插桩的证据化电量分析。 |
| 性能工具生态集成 | ✅ 已完成 | 2026-07-25 03:08:58 +0800 | `6f2b603` | 完成各 profiler 与统一 Shell 的集成。 |
| 统一本地分析工作流 | ✅ 已完成 | 2026-07-25 15:09:18 +0800 | `7c34b0f` | 统一桌面性能分析入口和跨功能协作。 |
