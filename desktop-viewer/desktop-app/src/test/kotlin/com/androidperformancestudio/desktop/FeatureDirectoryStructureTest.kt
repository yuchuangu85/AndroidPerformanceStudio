...
class FeatureDirectoryStructureTest {
    ...
    fun `root desktop app exclusively owns process entry and native packaging`() {
        ...
        val mainSource = "src/main/kotlin/com/androidperformancestudio/desktop/Main.kt"
    ...
    fun `root desktop app owns the unified home shell`() {
        val shellSource = root.resolve("desktop-app/src/main/kotlin/com/androidperformancestudio/desktop")
