...
class UnifiedSettingsMigrationTest {
    ...
    private fun desktopSource(fileName: String): String =
        Files.readString(Path.of("src/main/kotlin/dev/agentperf/desktop/$fileName"))

    private fun layoutInspectorSource(fileName: String): String =
        Files.readString(
            Path.of("../layout-inspector/presentation/src/main/kotlin/dev/agentperf/desktop/$fileName"),
        )
