...
class ApplicationVersionTest {
    ...
    @Test
    fun `project version defaults to 0_1_3 and accepts the appVersion property`() {
        assertTrue(projectBuildScript.contains("""val defaultAppVersion = "0.1.3""""))
        assertTrue(
    ...
    fun `desktop distributions use the resolved project version`() {
        ...
        assertFalse(desktopBuildScript.contains("""packageVersion = "0.1.3""""))
    }
