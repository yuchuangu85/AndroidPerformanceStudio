...
class ReleaseWorkflowTest {
    ...
    fun `publish job has write access and stable native asset names`() {
        ...
        assertTrue(workflow.contains("AndroidPerfermanceStudio-${'$'}VERSION-macos-x64.dmg"))
        assertTrue(workflow.contains("AndroidPerfermanceStudio-${'$'}VERSION-macos-x64.pkg"))
