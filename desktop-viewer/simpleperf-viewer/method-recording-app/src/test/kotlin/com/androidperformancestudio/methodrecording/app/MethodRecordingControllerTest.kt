...
class MethodRecordingControllerTest {
    @Test
    fun `importing a trace populates analysis, top methods and flame graph`() =
        runTest {
    ...
    @Test
    fun `importing a non-trace file reports an error`() =
        runTest {
            val controller = MethodRecordingController(adbExecutable = null, sessionRoot = Files.createTempDirectory("mr"))
    ...
    @Test
    fun `refresh devices without adb reports a helpful message`() =
        runTest {
            val controller = MethodRecordingController(adbExecutable = null, sessionRoot = Files.createTempDirectory("mr"))
