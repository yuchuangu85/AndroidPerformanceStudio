...
private val CHINESE_TEXT =
    mapOf(
        ...
        "Sampling template" to "采集模板",
        "Capture configuration" to "采集配置",
        "Advanced parameters" to "高级参数",
        "Simpleperf engine" to "Simpleperf 引擎",
        "User guide" to "用户指南",
        "Choose a starting point for Simpleperf capture." to "选择 Simpleperf 采集的起始模板。",
        "Configure event, rate, and duration." to "配置事件、采样率和持续时间。",
        "Tune call graph collection and event scope." to "调整调用图采集和事件范围。",
        "Choose how frame information follows pointer movement." to "选择帧信息框相对鼠标的显示方式。",
        "Choose where captured Simpleperf data is analyzed." to "选择采集后的 Simpleperf 数据分析引擎。",
        "Read the offline Simpleperf user guide in your default browser." to "在默认浏览器中阅读离线 Simpleperf 用户指南。",
        "Open User Guide in Browser" to "在浏览器中打开用户指南",
        "Frame information box" to "帧信息框",
        "Keep the Firefox-style frame details fixed in the corner or follow the mouse pointer." to
            "将 Firefox 风格的帧详情固定在角落，或让其跟随鼠标。",
        "Fixed" to "固定",
        ...
        "Back" to "返回",
        "Open a profile session to view its report." to "打开性能会话以查看报告。",
        ...
        "Total" to "总计",
        "Total (samples)" to "总计（样本）",
        "Flame graph" to "火焰图",
        "Stack chart" to "堆栈图",
        "Marker chart" to "标记图",
        "Marker table" to "标记表",
        "Show details" to "显示详情",
        "Hide details" to "隐藏详情",
        "All Frames" to "所有帧",
        "Script" to "脚本",
        ...
        "Details" to "详情",
        "Finding details" to "诊断详情",
        "Function details" to "函数详情",
        "Stack block details" to "堆栈块详情",
        "Marker details" to "标记详情",
        "Select a finding to inspect details." to "选择一条诊断以查看详情。",
        "Select a function to inspect details." to "选择一个函数以查看详情。",
        "Select a call stack frame to inspect details." to "选择一个调用栈帧以查看详情。",
        "Select a stack block to inspect details." to "选择一个堆栈块以查看详情。",
        "Select a marker to inspect details." to "选择一个标记以查看详情。",
        "Markers were not collected for this session." to "此会话未采集标记。",
        "The profile contains no markers." to "性能数据中没有标记。",
        "No markers overlap the selected range." to "所选范围内没有标记。",
        "No markers match the current filter." to "没有标记匹配当前过滤条件。",
        "No markers are available." to "没有可用标记。",
        "No samples were collected for Stack Chart." to "未采集可用于堆栈图的样本。",
        "No stack samples overlap the selected range." to "所选范围内没有堆栈样本。",
        "The current stack filters removed every sample." to "当前堆栈过滤条件排除了所有样本。",
        "No stack blocks are available." to "没有可用堆栈块。",
        "Diagnostics" to "诊断",
        "Samples" to "样本",
        "Self" to "独占",
        "Running" to "运行",
