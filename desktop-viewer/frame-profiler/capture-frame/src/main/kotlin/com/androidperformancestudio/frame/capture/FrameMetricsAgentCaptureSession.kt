...
private fun AgentFrameSample.toFrameSample(
    ...
    FrameSample(
        ...
        fragmentName = states["fragment"],
        pageName = states["page"],
        interactionState = states["interaction"] ?: states["uiState"],
        renderThreadName = states["renderThread"],
        jankStatsJank = jankStatsJank,
        jankStatsReasons = jankStatsReasons,
        jankStatsRuleId = jankStatsRuleId,
        jankStatsRuleVersion = jankStatsRuleVersion,
        states = states,
