...
class LanguagePreferenceTest {
    ...
    fun `detail strings use typed resources instead of English lookup maps`() {
        val viewerStrings =
            Files.readString(
                Path.of("src/main/kotlin/com/androidperformancestudio/desktop/ViewerStrings.kt"),
            )
        val presenter =
            Files.readString(
                Path.of("src/main/kotlin/com/androidperformancestudio/desktop/NodeDetailsPresenter.kt"),
            )
